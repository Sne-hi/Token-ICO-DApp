...
contract TokenICO{
    ...
    function multiply(uint256 a, uint256 b) public pure returns (uint256 z){
        require(b == 0 || (z = a * b) / b == a);
    }

    function buyToken(uint256 _tokenAmount) public payable {
        // Implementation for buying tokens
    ...
    function transferToken(uint256 _amount) external payable{
